...
public class MapsActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        this.lat = Double.parseDouble(i.getStringExtra("latitud"));
        this.lng = Double.parseDouble(i.getStringExtra("longitud"));
        this.restaurante = i.getStringExtra("nombre");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng classroom = new LatLng(lat, lng);
        mMap.addMarker(new MarkerOptions().position(classroom).title(restaurante));
